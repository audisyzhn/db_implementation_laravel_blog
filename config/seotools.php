...
return [
    'meta' => [
        ...
        'defaults'       => [
            ...
            'description'  => 'Top Articles', // set false to total remove
            'separator'    => ' - ',
    ...
    'opengraph' => [
         ...
         */
        'defaults' => [
            'title'       => 'Learn Pretty Much Anything', // set false to total remove
            'description' => 'Top Articles', // set false to total remove
            'url'         => false, // Set null for using Url::current(), set false to total remove
            'type'        => "website",
            'site_name'   => "Learn Pretty Much Anything",
            'images'      => ["http://127.0.0.1:8000/laravel-logo.min.svg"],
            'brand'       => "Learn Pretty Much Anything",
        ],
    ],
    'twitter' => [
        /*
        ...
        'defaults' => [
            'card'            => 'summary',
            'site'            => '@audisyzhn',
            'title'           => 'Learn Pretty Much Anything',
            'description'     => 'Top Articles', // set false to total remove
